...
const ShippingAddressScreen = () => {
      ...
      .then((res) => {
        if (res.data.status == 200) {
          Swal.fire({
            ...
            background: "#151515",
            title:
              "<h5 style='color:#1ddb4f'>" + "address added successfull" + "</h5>",
  ...
  const deleteAddress = async (id) => {
    await axios
      .delete(`http://3.111.36.104/user/remove-address/`, {
        headers: {
          Authorization: `bearer ${userInfo.access} `,
  ...
  return (
    <div>
      ...
      <div className="container small-container" style={{marginTop:"70px"}}>
